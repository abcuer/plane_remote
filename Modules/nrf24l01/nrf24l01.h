...
#define Clr_NRF24L01_CSN    HAL_GPIO_WritePin(GPIOA, NRF_CSN_Pin, GPIO_PIN_RESET)
...
// SPI(NRF24L01)寄存器地址
#define NCONFIG         0x00  // 配置寄存器地址；bit0:1接收模式，0发送模式;bit1:电源选择;bit2:CRC模式;bit3:CRC使能;
                              // bit4:中断MAX_RT(达到最大重发次数中断)使能;bit5:中断TX_DS使能;bit6:中断RX_DR使能
#define EN_AA           0x01  // 使能自动应答功能  bit0~5，对应通道0~5
#define EN_RXADDR       0x02  // 接收地址允许，bit0~5，对应通道0~5
#define SETUP_AW        0x03  // 设置地址宽度(所有数据通道):bit1,0:00,3字节;01,4字节;02,5字节;
#define SETUP_RETR      0x04  // 建立自动重发;bit3:0，自动重发计数器;bit7:4，自动重发延迟 250*x+86us
#define RF_CH           0x05  // RF通道，bit6:0，工作通道频率;
#define RF_SETUP        0x06  // RF寄存器;bit3:传输速率(0:1Mbps,1:2Mbps);bit2:1，发射功率;bit0:低噪声放大器增益
#define STATUS          0x07  // 状态寄存器;bit0:TX FIFO满标志;bit3:1，接收数据通道号(最大:6);bit4，达到最多重发次数
